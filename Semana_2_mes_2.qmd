...
```
<br>
**En este paso se transforma los títulos de las columnas a minusculas**
...
```
<br>
**Letras iniciales en Mayusculas**
...
```
<br>
**Se eliminan las columnas con porcentaje**
