...
En este ejemplo se crea una variable de tipo cuatitativa contínua, que lleva el nombre de P
Luego se extrae 5 valores de la variable P, pero de manera aleatoria
